...
class PickupDeadlineReminderTest extends TestCase
{
    ...
    public function test_sends_notification_when_pickup_deadline_is_30_minutes_away(): void
    {
        Notification::fake();
        ...
        // Create an order that expires in exactly 30 minutes
        $order = Order::create([
    ...
    public function test_does_not_send_notification_when_pickup_deadline_is_not_30_minutes_away(): void
    {
        Notification::fake();
        \Illuminate\Support\Carbon::setTestNow('2026-06-03 12:00:00');
        ...
        // Create an order that expires in 60 minutes
        $order = Order::create([
            'customer_id' => $consumer->id,
            'mitra_id' => $mitra->id,
            'total_amount' => 50000,
